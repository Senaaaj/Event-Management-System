...
<html>
	...
	<body>
		<section class="box">
			<h1>Update A Previous Flower Decoration Order</h1>
			
			<div class="form">
				<form action="updateflower.php" method="post" onsubmit="validData(event)">
					...
					<input type="submit" id="button" value="Update Details">
